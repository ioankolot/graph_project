...
graph_dataset3 = [[] for _ in range(len(graph_instances))]
cntr = 0

for graph in graph_instances[100:150]:
    minimum_energy = 0
    ...
    graph_dataset3[cntr].append(minimum_energy, optimal_beta, optimal_gamma)
    cntr += 1

np.save('dataset_3.npy', np.array(graph_dataset3))
