...
graph_dataset1 = [[] for _ in range(len(graph_instances))]
cntr = 0

for graph in graph_instances[:50]:
    minimum_energy = 0
    ...
    graph_dataset1[cntr].append(minimum_energy, optimal_beta, optimal_gamma)
    cntr += 1

np.save('dataset_1.npy', np.array(graph_dataset1))
