...
for i in range(50):
    old_betas[i].append(layer_3_dataset[i][1] + [layer_3_dataset[i][2]])
    old_gammas[i].append(layer_3_dataset[i][3] + [layer_3_dataset[i][4]])
...
for num in range(50):
    ...
    nelder_old_betas = old_betas[num][0]
    print(nelder_old_betas)
    nelder_old_gammas = old_gammas[num][0]
    ...
    graph_dataset1_layer4[cntr].append(old_betas[num][0])
    graph_dataset1_layer4[cntr].append(optimal_beta)
    graph_dataset1_layer4[cntr].append(old_gammas[num][0])
    graph_dataset1_layer4[cntr].append(optimal_gamma)
    cntr += 1

np.save('dataset_1_layer4.npy', np.array(graph_dataset1_layer4))
