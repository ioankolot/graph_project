...
for num in range(50:100):
    ...
    graph_dataset2_layer2[cntr].append(minimum_energy)
    graph_dataset2_layer2[cntr].append(old_betas[num])
    graph_dataset2_layer2[cntr].append(optimal_beta)
    graph_dataset2_layer2[cntr].append(old_gammas[num])
    graph_dataset2_layer2[cntr].append(optimal_gamma)
    cntr += 1

np.save('dataset_2_layer2.npy', np.array(graph_dataset2_layer2))
